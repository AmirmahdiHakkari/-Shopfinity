...
const AboutPage = () => {
  ...
  const techStack = [
    ...
    { name: "React Table", icon: <FaTable className="text-emerald-500" /> }, 
    { name: "ApexCharts", icon: <FaChartLine className="text-orange-600" /> },
    { name: "React Helmet", icon: <FaReact className="text-indigo-500" /> }, 
    { name: "React Toastify", icon: <FaBell className="text-yellow-500" /> },
  ];
