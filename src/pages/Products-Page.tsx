...
const ProductsPage = () => {
  ...
  useEffect(() => {
    const uniqueCats = [
      t("Products-Page-Filter-All"),
      t("Products-Page-Filter-Beauty"),
      t("Products-Page-Filter-Fragrances"),
      t("Products-Page-Filter-Furniture"),
      t("Products-Page-Filter-Groceries"),
    ];
    setCategories(uniqueCats);

    if (!uniqueCats.includes(selectedCategory)) {
      setSelectedCategory(t("Products-Page-Filter-All"));
    }
  }, [t]);

  const categoryMap: Record<string, string> = {
    [t("Products-Page-Filter-All")]: "all",
    [t("Products-Page-Filter-Beauty")]: "beauty",
    [t("Products-Page-Filter-Fragrances")]: "fragrances",
    [t("Products-Page-Filter-Furniture")]: "furniture",
    [t("Products-Page-Filter-Groceries")]: "groceries",
  };

  const filteredProducts =
    selectedCategory === t("Products-Page-Filter-All")
      ? products
