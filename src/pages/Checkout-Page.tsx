...
const CheckoutPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl font-bold mb-4">
          {t("checkout-Page-Form-Header")}
        </h2>
        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
          <div>
            <label className="block font-semibold mb-1">
              {t("checkout-Page-Form-Name")}
            </label>
            <input
              type="text"
              className={clsx(
              ...
              {...register("Name", {
                required: t("checkout-Page-Form-Name-Required-Error"),
                minLength: {
                  value: 3,
                  message: t("checkout-Page-Form-Name-MinLength-Error"),
                },
                maxLength: {
                  value: 25,
                  message: t("checkout-Page-Form-Name-MaxLength-Error"),
                },
              })}
            />
            {errors.Name && (
          ...
          <div>
            ...
            <input
              ...
              {...register("Email", {
                required: t("checkout-Page-Form-Email-Required-Error"),
                pattern: {
                  value: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
                  message: t("checkout-Page-Form-Email-Invalid-Error"),
                },
              })}
            />
            {errors.Email && (
          ...
          <div>
            ...
            <textarea
              ...
              {...register("Address", {
                required: t("checkout-Page-Form-Address-Required-Error"),
                minLength: {
                  value: 3,
                  message: t("checkout-Page-Form-Address-MinLength-Error"),
                },
              })}
            />
            {errors.Address && (
          ...
          >
            {t("checkout-Page-Order-Registration")}
          </button>
        </form>
      </div>
    </div>
